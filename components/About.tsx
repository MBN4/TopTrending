        ...
        <section id="about" className="py-24 relative overflow-hidden bg-white dark:bg-zinc-950 transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <span className="inline-block py-1 px-3 rounded-full bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 text-xs font-bold uppercase tracking-widest mb-4">
                            {ABOUT_CONTENT.badge}
                        </span>
                        <h2 className="text-4xl md:text-6xl font-black mb-6 leading-tight tracking-tighter text-gray-900 dark:text-white">
                        ...
                        <div className="grid grid-cols-2 gap-8 mb-10">
                            {ABOUT_CONTENT.stats.map((stat, idx) => (
                                ...
                                >
                                    ...
                                    <span className="text-[10px] md:text-xs font-black text-gray-500 dark:text-zinc-500 uppercase tracking-[0.2em] leading-tight max-w-[120px]">
                                        {stat.label}
                                    </span>
                                </motion.div>
                            ))}
                        ...
                        <LiquidButton
                            className="bg-gray-900 dark:bg-white !text-white dark:!text-zinc-950"
                        >
                            Learn More About Us
                        </LiquidButton>
                    </motion.div>
                    ...
                    {ABOUT_CONTENT.pillars.map((item, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="p-8 rounded-3xl border border-gray-100 dark:border-zinc-800 transition-colors"
                            >
                                <Icon className="w-10 h-10 text-red-600 mb-6" />
                                <h3 className="text-xl font-black mb-4 text-gray-900 dark:text-white uppercase tracking-tight">{item.title}</h3>
                                <p className="text-gray-600 dark:text-zinc-400 font-medium">{item.desc}</p>
                            </motion.div>
                        );
                    })}
                </div>
